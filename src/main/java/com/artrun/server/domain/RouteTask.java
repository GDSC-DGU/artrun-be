...
public class RouteTask {
    ...
    private String requestText; private String shapeType; private String activityType; private Double targetDistanceKm;
    @Column(columnDefinition = "geometry(Point, 4326)") private Point startPoint;
    private Boolean avoidMainRoad; private Boolean preferPark; private String errorMessage;
    @Column(nullable = false, updatable = false) private LocalDateTime createdAt; private LocalDateTime completedAt;
